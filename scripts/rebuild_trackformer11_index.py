#!/usr/bin/env python3
"""Rebuild trackformer11-hindcasts.json from the per-storm files on disk.
...
INDEX = os.path.join(MODEL, "trackformer11-hindcasts.json")
STORMS = os.path.join(MODEL, "trackformer11")

NOTE = ("Per-storm Trackformer1.1 hindcasts, loaded lazily. History mode uses Trackformer1.1 wherever a run "
        "covers the initialisation on screen and Trackformer1.0 elsewhere.")
