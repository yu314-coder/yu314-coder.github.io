#!/usr/bin/env python3
"""Shrink the stored Trackformer1.1 hindcasts without changing what they say.
...
before any are dropped -- so how many are kept for drawing is a display choice.
    ...
    python scripts/compact_trackformer11_hindcasts.py            # rewrite in place
    python scripts/compact_trackformer11_hindcasts.py --check     # report, write nothing
    python scripts/compact_trackformer11_hindcasts.py --members 12
"""
...
TF11 = ROOT / "assets" / "typhoon-tracker" / "model" / "trackformer11"
