#!/usr/bin/env python3
"""TrackFormer v23 inference core, vendored into this repo.
...
_terrain = np.load(HERE / "v23_terrain_wp.npz")
...
def build_window(times, tns, lat, lon, vmax, pres):
    ...
    from trackformer_v23 import TMEAN, TSTD
...
def run_forecast(models, times, tns, lat, lon, vmax, pres):
    from trackformer_v23 import TARGET_SCALE
    import math
