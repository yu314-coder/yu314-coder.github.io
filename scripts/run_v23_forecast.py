#!/usr/bin/env python3
"""Precompute TrackFormer v23 forecasts for every currently-active JMA tropical cyclone,
...
def load_models():
    ...
    for c in ckpts:
        ...
        models.append(m)
    print(f"loaded {len(models)} v23 seeds from {MODELS_DIR}", file=sys.stderr)
    return models
